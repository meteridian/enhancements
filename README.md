...
|------|---------|---------------|
| **Credits** | Platform-level prepaid balance (e.g., "100 credits/core-hour"). Used for committed spend, prepaid packages, drawdown. Industry standard (cf. Snowflake credits, Google Cloud credits). | METR-0004 |
| **Budget units** | Internal allocation units for chargeback/showback within an organization. Departments "spend" budget units; finance "allocates" them. | METR-0005 |
| **Tokens** | Reserved for blockchain/DePIN settlement (v2). Burn-and-Mint Equilibrium, on-chain settlement, stablecoin integration. | ROADMAP (deferred) |
