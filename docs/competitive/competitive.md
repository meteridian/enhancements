...
| **K8s cost allocation** | Excellent | Good | Good | Good | **Excellent (Koku heritage)** |
...
| Provider | CloudHealth | Kubecost | Vantage | CAST AI | Snowflake (Cost) | OpenCost | **Meteridian** |
|----------|-------------|----------|---------|---------|-----------------|----------|----------------|
| AWS | Yes | No | Yes | No | No | No | **Yes (Tier 1)** |
| Azure | Yes | No | Yes | No | No | No | **Yes (Tier 1)** |
| GCP | Yes | No | Yes | No | No | No | **Yes (Tier 1)** |
| Kubernetes | No | Yes | Yes | Yes | No | Yes | **Yes (Tier 1, OCP)** |
| IBM Cloud | No | No | No | No | No | No | **Yes (Tier 2, v1.1)** |
| Oracle Cloud | No | No | Yes | No | No | No | **Yes (Tier 2, v1.1)** |
| Alibaba Cloud | No | No | No | No | No | No | **Yes (Tier 2, v1.1)** |
| Huawei Cloud | No | No | No | No | No | No | **Yes (Tier 2, v1.1)** |
| OpenAI | No | No | Yes | No | No | No | **Yes (Tier 3, v1.2)** |
| Anthropic | No | No | Yes | No | No | No | **Yes (Tier 3, v1.2)** |
| Snowflake | No | No | Yes | No | Yes | No | **Yes (Tier 3, v1.2)** |
| Databricks | No | No | Yes | No | No | No | **Yes (Tier 3, v1.2)** |
| Datadog | No | No | Yes | No | No | No | **Yes (Tier 3, v1.2)** |
| Any (via FOCUS) | No | No | Yes | No | No | No | **Yes (Tier Custom, v1.0)** |
| On-premises | No | Partial | No | No | No | Partial | **Yes (Tier 1)** |

### Meteridian Provider Tiers

| Tier | Release | Integration type | Providers |
|------|---------|-----------------|-----------|
| **Tier 1** | v1.0 | Native source blocks + real-time metering | RHOAI (CloudEvents), AWS, Azure, GCP, OCP |
| **Tier 2** | v1.1 | Native source blocks | IBM Cloud, Oracle Cloud, Alibaba Cloud, Huawei Cloud |
| **Tier 3** | v1.2+ | API polling and webhook integrations | OpenAI, Anthropic, Datadog, Snowflake, Databricks, MongoDB, and others |
| **Tier Custom** | v1.0 | FOCUS CSV upload or API ingestion | Any provider that exports FOCUS v1.4 data |

**FOCUS as a Differentiator:** Unlike competitors that require a custom
integration per provider, Meteridian's FOCUS v1.4 ingestion pipeline (ADR-0020)
enables immediate support for any provider that exports FOCUS-format billing
data. This means enterprises can onboard new providers in minutes (upload a
FOCUS CSV) rather than waiting months for a native integration to be developed.
