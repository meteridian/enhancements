...
| **Revenue recognition** | "Deferred revenue must reconcile with credit ledger within tolerance" | Credit grant, consumption, period close |
...
| `meteridian-revrec` | Global (ASC 606 and IFRS 15) | Revenue recognition policy validation, deferred revenue controls, journal entry integrity, multi-element allocation verification (METR-0004 §10) | P1 |
...
| **Revenue Recognition Schedule** | ASC 606 and IFRS 15 | JSON, CSV, or ERP-specific format | Finance team, external auditors | Monthly or on-demand |
...
| `compliance-export-revrec` | Revenue recognition journal entries and schedules (ASC 606 and IFRS 15) for ERP integration | P1 |
