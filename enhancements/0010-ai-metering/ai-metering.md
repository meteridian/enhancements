...
> **Pluggable AI Source blocks (METR-0002):** AI metering follows Meteridian's
> pluggable block philosophy. Any AI platform that emits CloudEvents (or can be
> adapted to do so) can serve as a Source block. Users are not locked into
> RHOAI — they can configure Source blocks for OpenAI-compatible endpoints,
> Azure OpenAI, AWS Bedrock, GCP Vertex AI, self-hosted vLLM, or any custom
> inference gateway. The data source is a pipeline configuration choice, not a
> platform limitation.
